...
```gradle
dependencies {
    implementation 'com.github.apiverve:currencysymbols-api:1.1.12'
}
```
...
```java
import com.apiverve.currencysymbols.CurrencySymbolsAPIClient;
import com.apiverve.currencysymbols.APIResponse;
import com.apiverve.currencysymbols.APIException;

// Initialize the client
CurrencySymbolsAPIClient client = new CurrencySymbolsAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/currencysymbols](https://docs.apiverve.com/ref/currencysymbols)
...
- **Documentation:** [https://docs.apiverve.com/ref/currencysymbols](https://docs.apiverve.com/ref/currencysymbols)
- **Issues:** [GitHub Issues](https://github.com/apiverve/currencysymbols-api/issues)
