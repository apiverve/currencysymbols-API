# Currency Symbols API - Examples

This folder contains example code for using the Currency Symbols API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/currencysymbols',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/currencysymbols");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/currencysymbols](https://docs.apiverve.com/ref/currencysymbols)
